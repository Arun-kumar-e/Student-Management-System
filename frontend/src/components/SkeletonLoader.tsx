    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: count }).map((_, index) => (
        <motion.div
          ...
          variants={shimmerVariants}
          animate="animate"
          className="p-6 rounded-2xl border border-surface-border bg-surface-card space-y-4"
        >
...
export const DetailSkeleton = () => {
  return (
    <motion.div
      variants={shimmerVariants}
      animate="animate"
      className="max-w-3xl mx-auto rounded-3xl border border-surface-border bg-surface-card overflow-hidden"
    >
    ...
    <div className="space-y-8 w-full">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {Array.from({ length: 3 }).map((_, index) => (
          <motion.div
            ...
            variants={shimmerVariants}
            animate="animate"
            className="p-6 rounded-2xl border border-surface-border bg-surface-card flex items-center space-x-4"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <motion.div
          variants={shimmerVariants}
          animate="animate"
          className="lg:col-span-2 p-6 rounded-2xl border border-surface-border bg-surface-card h-80"
        >
          <div className="h-6 bg-surface-border rounded-md w-1/4 mb-6" />
          <div className="h-4/5 bg-surface-border rounded-xl" />
        </motion.div>
        <motion.div
          variants={shimmerVariants}
          animate="animate"
          className="p-6 rounded-2xl border border-surface-border bg-surface-card h-80"
        >
